...
dec = AttnDecoderLSTM(WORD_SIZE,WORD_DIM,HIDDEN_SIZE*2,pretrained_word_embeds)
model = QuestionGeneration(enc2, dec)

#checkpoint = torch.load('/content/drive/My Drive/Colab Notebooks/qa/best_validation_loss_model.pth.tar')
